 ...
 */
declare const DiscordVoiceRegionCoordinates: Record<string, RegionCoordinates>;
/**
 ...
 */
declare function getVoiceRegionCoordinates(region?: string | null): RegionCoordinates | undefined;
/**
 ...
 */
declare function haversineDistance(a: RegionCoordinates, b: RegionCoordinates): number;
/**
 ...
 */
declare const AirportRegions: Record<string, string>;
/**
 ...
 */
declare const KnownRegions: Set<string>;
/**
 ...
 */
declare const AirportCoordinates: Record<string, RegionCoordinates>;
/** Where a voice endpoint is hosted. */
type VoiceEndpointProvider = "cloudflare" | "discord" | "unknown";
/**
 ...
 * ```
 */
declare function classifyVoiceEndpoint(endpoint?: string | null): {
    region?: string;
    provider: VoiceEndpointProvider;
    iata?: string;
};
...
declare class Player {
     ...
     */
    switchVoiceChannel(voiceChannelId: string, selfDeaf?: boolean, selfMute?: boolean): Promise<this>;
    /**
     ...
     */
    markVoiceHandshakeComplete(): void;
...
declare class LavalinkNode {
     ...
     */
    get coordinates(): RegionCoordinates | null;
    /**
